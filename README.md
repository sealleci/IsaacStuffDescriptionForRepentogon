...
- Press **Left** to enter **Inspect Mode**.
- Use the **Up, Down, Left, and Right** directional controls to move the cursor between collected items.
- When the cursor reaches the rightmost item, pressing **Right** again exits Inspect Mode and returns control to the pause menu.
